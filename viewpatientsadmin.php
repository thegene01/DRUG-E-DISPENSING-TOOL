...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="viewthepatientadmin.php?patientId=<?php echo $row['userId']; ?>"><button>VIEW</button></a>
            <a href="deletepatient.php?patientId=<?php echo $row['userId']; ?>"><button>DELETE</button></a></td>
        </tr>
        <?php
        }
        ?>
